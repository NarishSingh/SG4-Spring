/*
Now with two ctors and nonstatic roster file to allow for seperation of production
and test code
 */
...
public class ClassRosterDaoImpl implements ClassRosterDao {
    ...
    public final String ROSTER_FILE; //declaration only, allow the ctors to attach
     ...
     *
     * @throws ClassRosterPersistenceException {IOException} if an error occurs
     *                                         writing file
     */
